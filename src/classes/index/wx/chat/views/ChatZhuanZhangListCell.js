                            ...
                            <View style={{flexDirection:'row',marginLeft:5,flex: 1,marginRight:5,justifyContent:isSelf ? 'flex-end' : 'flex-start' }}>
                                <View>
                                    ...
                                    <View style={{position:'absolute',left:49,top:11}}>
                                        <Text style={{fontSize:16,color:Colors.white,fontWeight:'bold'}} >￥10000.00</Text>
                                        <Text style={{fontSize:12,color:Colors.white,marginLeft:4}} >{isReceived ? '已被领取' : '转账给你'}</Text>
                                    </View>
