        ...
        return (
            <YHTouchableOpacity style={styles.container} onPress={this.props.itemClick}>
                <View style={{flexDirection: 'row', paddingVertical: 11, paddingHorizontal: 15, alignItems: 'center'}}>
                    {!isGroup ?
                        <XImage iconSize={53} style={{borderRadius: 53}} icon={{uri: data.userinfo.avatar}}/> : (
                    ...
                    <View style={{flex: 1, marginLeft: 11,}}>
                        <Text style={{fontSize: 17, color: Colors.black_text_color}}>{isGroup?data.group_name:data.userinfo.user_name}</Text>
                        <Text style={{
                            fontSize: 14,
