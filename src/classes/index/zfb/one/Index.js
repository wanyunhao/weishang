...
export default class Index extends ZFBBaseVC {
    ...
    _chooseImg() {
        SyanImagePicker.showImagePicker({
            ...
            RNStorage.zfb_bg_one = selectedPhotos[0].base64;
            // 选择成功，渲染图片
            this.setState({
    ...
    _addSubView() {
        return (
            <>
                ...
                {/*        </View>*/}
                {/*    </View>*/}
                    {RNStorage.zfb_bg_one != undefined ? null :(<YHTouchableOpacity style={{flex:1,}} text='上传' onPress={()=>{
                        this._chooseImg()
                    }}/>)}
                {/*</View>*/}
            </>
