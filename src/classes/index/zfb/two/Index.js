            ...
            <View style={{height:119,backgroundColor:Colors.zfb_theme_color}}>
                <View style={{flexDirection:'row',alignItems:'center',paddingHorizontal:15,marginTop:10,}}>
                    ...
                    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                        <XImage style={{width:21.37,height:23.42,marginRight:20,}} icon={require('../../../resource/zfb/two/zfb_cf_icon_xy.png')}/>
                        <XImage style={{width:22.65,height:20.17,marginRight:20,}} icon={require('../../../resource/zfb/two/zfb_cf_icon_b.png')}/>
                        <XImage style={{width:20.5,height:19.75}} icon={require('../../../resource/zfb/four/zfb_py_search.png')}/>
                    </View>
                </View>

                <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:15,marginTop:19}}>
                    <View>
                        <View style={{flexDirection:'row',alignItems:'center'}}>
                            <Text style={{color:'#84C3F6',marginRight:13,fontSize:12}}>总资产(元)</Text>
                            <XImage icon={require('../../../resource/zfb/two/cf_icon_eye.png')} style={{width:15.47,height:11.1,marginRight:11,}}/>
                            <View style={{flexDirection:'row',alignItems:'center',paddingHorizontal:6,borderRadius:8,height:16,backgroundColor:'#167BCB',justifyContent:'center'}}>
                                <XImage icon={require('../../../resource/zfb/two/cf_icon_bzz.png')} style={{width:8.4,height:9.77}}/>
                ...
                <View style={{alignItems:'center'}}>
                    <XImage icon={require('../../../resource/zfb/two/zfb_cf_icon_xl.png')} style={{width:14.26,height:5.68}}/>
                </View>
            </View>
        )
    }
