...
import SideBar from "../../../wx/contact/views/SideBar";
...
export default class ContactScreen extends BaseVC {
    ...
    componentDidMount() {
        ...
        super._setPlaceViewBackgroundColor('#B0B0B0')
    }
    ...
    _addSubView() {
        ...
        var headerListData = [];
        var headerImages = [
            require("../../../../resource/zfb/four/contact/zfb_txl_icon1.png"),
            require("../../../../resource/zfb/four/contact/zfb_txl_icon2.png"),
            require("../../../../resource/zfb/four/contact/zfb_txl_icon3.png"),
            require("../../../../resource/zfb/four/contact/zfb_txl_icon4.png"),
            require("../../../../resource/zfb/four/contact/zfb_txl_icon5.png"),
        ];
        var headerTitles = ["新的朋友", "群聊", "生活号", "生活圈","转账名片夹"];
        var index = 0;
        ...
        return (
            <View style={styles.container}>
                <ZFBNavigationBar title='通讯录' left_img={require('../../../../resource/zfb/common/zfb_sz_back.png')} nav_bg_color={Colors.white} title_color='#2B2B2B'/>
