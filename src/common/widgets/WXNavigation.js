...
export function WXNavigationBar({onBack, clickRText, clickRImage, clickRImage2, ...props}) {
    ...
    return <XView style={{backgroundColor: nav_bg_color != null ? nav_bg_color : '#EDEDED',}}>
        <XView style={[styles.titleBarParent, lineStyle,{backgroundColor: nav_bg_color != null ? nav_bg_color : '#EDEDED'}]}>
            ...
            {rightImage && <XImage style={{
                ...
                paddingLeft: 8,
                position: 'absolute',
            }} icon={rightImage} iconSize={20} onPress={() => clickRImage && clickRImage()}/>}
            {rightImage2 && <XImage style={{
                ...
                paddingLeft: 8,
                position: 'absolute',
            }} icon={rightImage2} iconSize={20} onPress={() => clickRImage2 && clickRImage2()}/>}
        </XView>
    </XView>;
}
